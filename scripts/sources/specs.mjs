...
const fileIcon = (id, name, tag, primary, secondary, tags) => ({
  id: `file.${id}`,
  name,
  type: 'icon',
  category: 'file',
...
export const ICONS = [
  /* --- System ---------------------------------------------------- */
  {
    ...
    tags: ['gear', 'config', 'options', 'preferences'],
  ...
  },
  {
    ...
    tags: ['shield', 'protection', 'defender', 'safety', 'privacy'],
    glyph:
  ...
  },
  {
    ...
    tags: ['folder', 'explorer', 'directory', 'documents'],
    glyph:
  ...
  },
  {
    ...
    tags: ['time', 'alarm', 'timer', 'schedule'],
    glyph:
  ...
  },
  {
    ...
    tags: ['date', 'schedule', 'agenda', 'month', 'events'],
    glyph:
  ...
  },
  {
    ...
    category: 'system',
    colors: { primary: '#F7A501', secondary: '#EB6B0C' },
    tags: ['notes', 'text', 'editor', 'write', 'document'],
    glyph:
  ...
  },
  {
    ...
    category: 'system',
    colors: { primary: '#0078D4', secondary: '#2AA0DA' },
    tags: ['delete', 'recycle bin', 'remove', 'bin'],
    glyph:
  ...
  },
  {
    ...
    category: 'system',
    colors: { primary: '#0078D4', secondary: '#2AA0DA' },
    tags: ['wifi', 'connection', 'signal', 'internet', 'wireless'],
    glyph:
  ...
  /* --- Product --------------------------------------------------- */
  {
    ...
    tags: ['email', 'inbox', 'message', 'envelope', 'outlook'],
    glyph:
  ...
  },
  {
    ...
    family: 'm365',
    colors: { primary: '#0078D4', secondary: '#2AA0DA' },
    tags: ['message', 'conversation', 'teams', 'bubble', 'talk'],
    glyph:
  ...
  },
  {
    ...
    tags: ['call', 'dial', 'contact', 'telephone'],
    glyph:
  ...
  },
  {
    ...
    tags: ['image', 'gallery', 'picture', 'album'],
    glyph:
  ...
  },
  {
    ...
    tags: ['audio', 'song', 'note', 'player', 'media'],
    glyph:
  ...
  },
  {
    ...
    tags: ['shop', 'bag', 'apps', 'marketplace', 'purchase'],
    glyph:
  ...
  },
  {
    ...
    tags: ['cloud', 'sun', 'forecast', 'climate'],
    glyph:
  ...
  },
  {
    ...
    family: 'gaming',
    colors: { primary: '#107C10', secondary: '#4CAF50' },
    tags: ['controller', 'xbox', 'play', 'games'],
    glyph:
  ...
  },
  {
    ...
    category: 'product',
    colors: { primary: '#0F6CBD', secondary: '#2AA0DA' },
    tags: ['web', 'edge', 'internet', 'globe', 'world'],
    glyph:
  ...
  },
  {
    ...
    tags: ['location', 'pin', 'navigation', 'place', 'directions'],
    glyph:
...
export const ILLUSTRATIONS = [
  {
    ...
    tags: ['nothing here', 'zero state', 'space', 'blank', 'no results'],
...
<defs><linearGradient id="night" x1="4" y1="10" x2="92" y2="86" gradientUnits="userSpaceOnUse"><stop stop-color="#16233F"/><stop offset="1" stop-color="#2B1B4A"/></linearGradient></defs>`,
  },
  {
    ...
    tags: ['onboarding', 'hello', 'start', 'first run', 'setup'],
...
<path d="M71 24.2 73.2 26.4 77.2 22" stroke="#107C10" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
  },
  {
    ...
    family: 'fluent',
    colors: { primary: '#107C10', secondary: '#4CAF50' },
    tags: ['done', 'complete', 'confirmation', 'checkmark', 'celebrate'],
...
<defs><linearGradient id="succ" x1="22" y1="22" x2="74" y2="74" gradientUnits="userSpaceOnUse"><stop stop-color="#4CAF50"/><stop offset="1" stop-color="#107C10"/></linearGradient></defs>`,
  },
  {
    ...
    family: 'fluent',
    colors: { primary: '#D13438', secondary: '#EB6B0C' },
    tags: ['problem', 'failure', 'warning', 'something went wrong', 'alert'],
...
<defs><linearGradient id="err" x1="18" y1="14" x2="78" y2="74" gradientUnits="userSpaceOnUse"><stop stop-color="#EB6B0C"/><stop offset="1" stop-color="#D13438"/></linearGradient></defs>`,
  },
  {
    ...
    family: 'windows',
    colors: { primary: '#0078D4', secondary: '#8764B8' },
    tags: ['add files', 'drop zone', 'import', 'attach', 'cloud'],
...
<path d="m38.5 49 9.5-9.5 9.5 9.5" stroke="#0078D4" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
  },
  {
    ...
    tags: ['refresh', 'update', 'cloud sync', 'in progress', 'loading'],
...
/* Lifecycle metadata. Anything not listed here is active/stable.
   Kept in one place so a release manager can flip channels without
   touching artwork. */
export const LIFECYCLE = {
  'product.gaming': { build: 'beta' },
  'product.sync': { build: 'beta' },
  'fluent.error': { build: 'beta' },
  'system.notepad': { status: 'active', build: 'alpha' },
  'file.text-file': { status: 'inactive', build: 'deprecated', deprecatedBy: 'file.code-file' },
};
